 ...
 *  RGBW Lights
 *
 *  Patrick Joyce (Credit goes to: Brian Freund (@brianfreund) whose HTTP request app I used as the basis for this app.
 *
 ...
 * 5. Changed icon URLs to openly licensed icon
 * 6. Added change log as required by license of the source app.
...
description: "A SmartApp that can control your Milights naively through python script running on your local network.",
category: "Lights",
iconUrl: "",
iconX2Url: "",
iconX3Url: "")
